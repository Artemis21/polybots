...
class Utils(commands.Cog):
    ...
    @commands.has_permissions(manage_channels=True)
    @commands.command(brief="Reset the **entire** server.", name="reset-server")
    ...
    @commands.command(brief="Award a role to many people.", name="mass-role")
    @commands.has_permissions(manage_roles=True)
    async def mass_role(self, ctx: Ctx, role: discord.Role, *users: discord.Member):
    ...
    @commands.command(brief="Clear a role from people.", name="clear-role")
    @commands.has_permissions(manage_roles=True)
